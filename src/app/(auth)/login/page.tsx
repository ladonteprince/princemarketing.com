    ...
    <div className="flex min-h-screen items-center justify-center px-6">
      <div className="w-full max-w-sm">
        ...
        <button
          ...
          className="flex w-full items-center justify-center gap-3 rounded-lg border border-smoke bg-graphite px-4 py-3 text-sm font-medium text-cloud transition-colors hover:bg-smoke/20"
        >
